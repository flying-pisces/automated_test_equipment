...
ClassCommon::Error ConoscopeLib::CmdExportProcessed(ProcessingConfig_t& config)
{
...
ClassCommon::Error ConoscopeLib::CmdRegisterEventCallback(void (*callback)(ConoscopeEvent_t))
{
