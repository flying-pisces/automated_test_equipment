...
QString ToolReturnCode::_mErrorDescription = "";
...
ToolReturnCode::ToolReturnCode(QString value)
{
    ...
    while (iter.hasNext())
    {
        ...
        else if(itemName == RETURN_ITEM_ERROR_DESCRIPTION)
        {
            mErrorDescription = itemValue.toString();
        }
        else
        {
...
void ToolReturnCode::SetError(ClassCommon::Error eError)
{
    ...
    if(mError == ClassCommon::Error::Ok)
    {
        mErrorDescription = "";
    }
    else
    {
        mErrorDescription = ToolReturnCode::_mErrorDescription;
    }
}
...
QString ToolReturnCode::GetJsonCode()
{
    ...
    content.insert(RETURN_ITEM_ERROR_DESCRIPTION, mErrorDescription);
...
QString ToolReturnCode::GetErrorDescription()
{
