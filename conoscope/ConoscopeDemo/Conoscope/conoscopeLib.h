...
public:
    ...
    ClassCommon::Error CmdExportProcessed(ProcessingConfig_t &config, ProcessingResult_t &result);
    ...
    typedef char* (*f_CmdRegisterEventCallback)(void (*callback)(ConoscopeEvent_t, QString));
    CMD(CmdRegisterEventCallback);

    typedef char* (*f_CmdRegisterWarningCallback)(void (*callback)(QString));
    CMD(CmdRegisterWarningCallback);
    ...
    static QString GetErrorDescription(){ return ConoscopeLib::_mErrorDescription; }

    static void SetErrorDescription(QString description){ ConoscopeLib::_mErrorDescription = description; }
...
private:
    ...
    void ErrorMessage(ToolReturnCode& errorCode);
};
