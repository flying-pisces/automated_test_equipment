...
void Camera::FileTransferWrite(const void*, size_t ){}

void Camera::FileTransferRead(void*, size_t){}
...
ClassCommon::Error Camera::CheckConnection()
{
    return ClassCommon::Error::Ok;
}

ClassCommon::Error Camera::GetInterfaceInfo(Camera::InterfaceInfo_t&)
{
    return ClassCommon::Error::Ok;
}
...
ClassCommon::Error Camera::GetSerialNumber(QString&, QString&)
{
    return ClassCommon::Error::NotImplemented;
}

ClassCommon::Error Camera::GetSettings(CameraSettings_t&)
{
    return ClassCommon::Error::NotImplemented;
}

ClassCommon::Error Camera::Configure(struct CaptureConfig*)
{
    return ClassCommon::Error::Ok;
}

int Camera::GetCurrentCaptureTimeoutSteps(int)
{
    return -1;
}

ClassCommon::Error Camera::ConfigurePipeline(struct PipelineConfig *)
{
    return ClassCommon::Error::Ok;
}
...
ClassCommon::Error Camera::GetPulse(struct Pulse* )
{
    return ClassCommon::Error::Ok;
}

ClassCommon::Error Camera::GetStatus(enum Status& )
{
    return ClassCommon::Error::Ok;
}

ClassCommon::Error Camera::GetRawData(struct RawDataInfo &, QByteArray& , QByteArray &)
{
    return ClassCommon::Error::Ok;
}
...
ClassCommon::Error Camera::FwUpdate(QString , char* , size_t )
{
    return ClassCommon::Error::NotImplemented;
}

int Camera::FwUpdateConfigure(size_t )
{
    return 0;
}
...
// interface for I2C. it may not be necessary to have those interface
bool Camera::HW_I2CIsDeviceReady(unsigned char , unsigned char )
{
    return (true);
}

void Camera::HW_I2CSelectDevice(unsigned char , unsigned char )
{
    return;
}

bool Camera::HW_I2CSendAndReceiveData(const unsigned char *, unsigned char , unsigned char *, unsigned char )
{
    return (true);
}
...
void Camera::SetIntegerValue(const std::string , int )
{
    return;
}
...
void Camera::SetHw(QString , QString , float , int )
{

}

void Camera::_LogMessage(QString message)
{
    emit LogMessage(message);
}

void Camera::_LogInFile(QString header, QString message)
{
    emit LogInFile(header, message);
}
