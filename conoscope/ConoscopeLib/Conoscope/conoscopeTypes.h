...
#define RETURN_ITEM_ERROR_DESCRIPTION    "ErrorDescription"
...
#define RETURN_ITEM_AE_ROI_WIDTH     "AeRoiWidth"
#define RETURN_ITEM_AE_ROI_HEIGHT    "AeRoiHeight"
#define RETURN_ITEM_AE_ROI_X         "AeRoiX"
#define RETURN_ITEM_AE_ROI_Y         "AeRoiY"
...
#define RETURN_ITEM_CONFIG_DEBUG_EMULATED_WHEEL   "emulatedWheel"
...
typedef struct
{
    ...
    bool  AeEnable;                 // for information purpose only: indicate whether the measurement is AE
    int   AeExpoTimeGranularityUs;  // for information purpose only: Exposure time granularity
...
static MeasureConfigWithCropFactor_t CopyMeasureConfig(MeasureConfig_t& config)
{
    ...
    configOut.AeEnable = false;
    configOut.AeExpoTimeGranularityUs = 1;
...
typedef enum
{
    ...
    ConoscopeEvent_CaptureSequenceError,
    ConoscopeEvent_MeasureAEDone,
    ConoscopeEvent_MeasureAECancel,
    ConoscopeEvent_MeasureAEError
} ConoscopeEvent_t;
